...
// Добавим список элементов
    ...
    private View. OnClickListener clickAlertDialogListSingle = new
...
// если = -1, то ни один не выбран
                            . setSingleChoiceItems(items, chosen, new
    ...
    private View. OnClickListener clickAlertDialogListMulti = new
            View. OnClickListener() {
                @Override
                public void onClick(View view) {
                    final String[] items = getResources() . getStringArray(R. array. choose) ;
...
// с выбранными элементами
                            . setMultiChoiceItems(items, chosen, new
