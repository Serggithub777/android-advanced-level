                ...
                . setPositiveButton(R. string. yes, new
                        DialogInterface. OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                dismiss() ;
                                ((MainActivity)
                                        getActivity() ).onDialogResult(getString(R. string. yes) ) ;
                            }
                        } )
                . setNegativeButton(R. string. no, new
                        DialogInterface. OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                dismiss() ;
                                ((MainActivity)
                                        getActivity() ).onDialogResult(getString(R. string. no) ) ;
                            }
                        } )
                . setNeutralButton(R. string. dunno, new
                        DialogInterface. OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                dismiss() ;
                                ((MainActivity)
                                        getActivity()).onDialogResult(getString(R. string. dunno) ) ;
                            }
                        } ) ;
